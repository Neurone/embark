...
var Blockchain = function(userConfig, clientClass) {
  ...
  this.config = {
    ...
    networkType: this.userConfig.networkType || 'custom',
    networkId: this.userConfig.networkId || 1337,
    ...
    rpcApi: (this.userConfig.rpcApi || ['eth', 'web3', 'net', 'debug']),
...
var BlockchainClient = function(userConfig, clientName, env, onReadyCallback, onExitCallback) {
  ...
  switch (userConfig.ethereumClientName) {
    ...
    default:
      console.error('Unknow client: %s', userConfig.ethereumClientName);
      process.exit();
  }
