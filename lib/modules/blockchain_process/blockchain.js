...
var Blockchain = function(userConfig, clientClass) {
  ...
  let defaultWsApi = clientClass.DEFAULTS.defaultWsApi;
  if (this.isDev) {
  ...
  this.config = {
    ...
    networkType: this.userConfig.networkType || clientClass.DEFAULTS.networkType,
    networkId: this.userConfig.networkId || clientClass.DEFAULTS.networkId,
    ...
    whisper: (this.userConfig.whisper === undefined) || this.userConfig.whisper,
    maxpeers: ((this.userConfig.maxpeers === 0) ? 0 : (this.userConfig.maxpeers || 25)),
    bootnodes: this.userConfig.bootnodes || "",
    rpcApi: (this.userConfig.rpcApi || clientClass.DEFAULTS.defaultRpcApi),
    wsRPC: (this.userConfig.wsRPC === undefined) || this.userConfig.wsRPC,
  ...
  if (this.userConfig.proxy === false) {
...
Blockchain.prototype.run = function() {
  ...
  console.log("===============================================================================".magenta);
  console.log("===============================================================================".magenta);
  console.log(__("Embark Blockchain using %s", this.client.prettyName.underline).magenta);
  console.log("===============================================================================".magenta);
  console.log("===============================================================================".magenta);

  if (this.config.clientName === 'geth') this.checkPathLength();
...
Blockchain.prototype.createFundAndUnlockAccounts = function(cb) {
  DevFunds.new({userConfig: this.config}).then(devFunds => {
...
var BlockchainClient = function(userConfig, clientName, env, onReadyCallback, onExitCallback) {
  ...
  // if clientName is set, it ovverrides preferences
  ...
  console.debug("===> UserConfig: " + JSON.stringify(userConfig, null, 4));
