...
class DevFunds {
  ...
  // TOCHECK: Still needed? Which version is affected? It seems geth now (1.8.15) works well, I don't think this 'trick' is needed anymore
  _regularTxs(cb) {
    const self = this;
  ...
  // I suggest to remove this andthe corresponding test case
