...
const DEFAULTS = {
  ...
  "networkType": "dev",
  "networkId": 17,
  "defaultRpcApi": ['eth', 'web3', 'net', 'traces'],
  "defaultWsApi": ['eth', 'web3', 'net', 'shh', 'traces', 'pubsub'],
...
class ParityClient {
  ...
  determineRpcOptions(config) {
    ...
    if (config.rpcCorsDomain) {
      if (config.rpcCorsDomain === '*') {
        console.log('==================================');
        console.log(__('rpcCorsDomain set to "all"'));
  ...
  determineWsOptions(config) {
    ...
    if (config.wsRPC) {
      ...
      if (config.wsOrigins) {
        if (config.wsOrigins === '*') {
          console.log('==================================');
          console.log(__('wsOrigins set to "all"'));
          console.log(__('make sure you know what you are doing'));
          console.log('==================================');
        }
